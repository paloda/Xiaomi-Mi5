...
#define MSM_MPDEC_IDLE_FREQ		1593600
...
static DEVICE_ATTR(file_name, 0664, show_##file_name, store_##file_name);
...
static DEVICE_ATTR(startdelay, 0664, show_startdelay, store_startdelay);
static DEVICE_ATTR(delay, 0664, show_delay, store_delay);
static DEVICE_ATTR(down_lock_duration, 0664, show_down_lock_duration, store_down_lock_duration);
static DEVICE_ATTR(idle_freq, 0664, show_idle_freq, store_idle_freq);
static DEVICE_ATTR(min_cpus, 0664, show_min_cpus_online, store_min_cpus_online);
static DEVICE_ATTR(max_cpus, 0664, show_max_cpus_online, store_max_cpus_online);
static DEVICE_ATTR(min_cpus_online, 0664, show_min_cpus_online, store_min_cpus_online);
static DEVICE_ATTR(max_cpus_online, 0664, show_max_cpus_online, store_max_cpus_online);
static DEVICE_ATTR(max_cpus_online_susp, 0664, show_max_cpus_online_susp, store_max_cpus_online_susp);
static DEVICE_ATTR(suspend_defer_time, 0664, show_suspend_defer_time, store_suspend_defer_time);
static DEVICE_ATTR(enabled, 0664, show_bricked_enabled, store_bricked_enabled);
